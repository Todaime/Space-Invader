...
begin
    {Suivant la touche appuyée on le déplace}
    {Attention, les coordonées (0,0) sont en haut à gauche}
...
begin
	...
	Writeln('!!!Des envahisseurs ont été détéctés à la frontiere de notre galaxie!!! ');
	Writeln(' A bord de votre vaisseau X-9789 votre mission est de venir au secour de l''humanite');
	Writeln('Deplacez vous  et tirez a l"aide des touches directionnelles ');
	writeln('');
	writeln('(Enter a key to go back to the menu)');
	readln(key);
end;
